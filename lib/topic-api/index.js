...
function canVote(req, res, next) {
  if (!config.multiForum || req.user.staff) {
    return next();
  }
...
app.post('/topic/:id/comment', restrict, findTopic, findForum, canVote, function (req, res) {
...
app.post('/topic/:id/vote', restrict, findTopic, findForum, canVote, function (req, res) {
